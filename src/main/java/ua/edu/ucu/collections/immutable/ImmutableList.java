...
public interface ImmutableList {
    ...
    ImmutableList add(Object e); //додає елемент у
    // кінець колекції
    ...
    Object get(int index); //повертає елемент за індексом, та кидає виключну ситуацію, якщо індекс
    ...
    ImmutableList set(int index, Object e); //змінює значення елементу за індексом, та кидає
